#include "PlayingCardApplication.h"

PlayingCardApplication::PlayingCardApplication()
{
    this->_image = ThumbnailImage::PLAYING_CARD;
}

void PlayingCardApplication::run(sf::RenderWindow &mainWindow)
{
    checkIfRunnable();
    ...
    while (isRunning)
    {
        ...
        this->_textureToDrawOn->clear(sf::Color::Yellow);
        this->_textureToDrawOn->draw(card);
